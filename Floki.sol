...
contract FLOKI_TEST is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x0336dB8E217235bd609e122E11a9b06f47e3Cb0E); // Marketing Address
    ...
    string private _name = 'FLOKI_TEST';
    string private _symbol = 'FLOKI_TEST';
